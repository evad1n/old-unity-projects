...
public abstract class Vehicle : MonoBehaviour {
    ...
    public float overrideRotation = 0;
    ...
    public void SetTransform()
    {
        ...
        {
            transform.forward = direction + Quaternion.Euler(0, overrideRotation, 0) * Vector3.right;
        }
    }
    ...
    /// <summary>
    /// Align the vehicle to the flow field vector at its position
    /// </summary>
    /// <param name="flowVector">The sampled vector from the flow field</param>
    public Vector3 FollowField(Vector3 flowVector)
    {
        return Seek(transform.position + flowVector);
    }

    /// <summary>
    /// Apply drag to an object to simulate resistance
    /// </summary>
    /// <param name="coefficient">How much the object will be slowed</param>
    /// <returns></returns>
    public Vector3 Drag(float coefficient)
    {
